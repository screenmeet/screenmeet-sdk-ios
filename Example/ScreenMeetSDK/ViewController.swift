...
extension UIViewController {
    ...
    func showToast(_ message : String, font: UIFont = .systemFont(ofSize: 12.0)) {
        ...
        let toastLabel = UILabel(frame: CGRect(x: self.view.frame.size.width/2 - 75, y: self.view.frame.size.height-100-self.view.safeAreaInsets.bottom, width: 150, height: 35))
